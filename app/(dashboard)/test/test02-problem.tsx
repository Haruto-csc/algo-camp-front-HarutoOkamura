...
// export default function ProductsPage(id: string) {
...
//                     <Button type="submit" disabled={loading} className="bg-zinc-900 hover:bg-zinc-500 text-white disabled:pointer-events-none px-8">
//                         更新
//                     </Button>
//                 </div>
//             </form>
...
//                     <DialogHeader>
//                         <DialogTitle className="text-center">問題確認</DialogTitle>
//                     </DialogHeader>
...
//                     <Button asChild type="button" variant="outline" className="px-8">
//                         <Link href="/problems">キャンセル</Link>
//                     </Button>
//                     <Button type="submit" disabled={loading} className="bg-zinc-900 hover:bg-zinc-500 text-white disabled:pointer-events-none px-8">
//                         更新内容を確認
//                     </Button>
...
//                 <DialogContent className="w-auto max-h-[85vh] overflow-y-auto">
//                     <DialogHeader>
//                         <DialogTitle className="text-center">問題内容の確認</DialogTitle>
//                     </DialogHeader>

//                     <div className="space-y-4 text-sm p-4">
//                         <p className="font-medium border-b pb-2 text-center text-amber-600">以下の内容で変更を保存してよろしいですか？</p>
